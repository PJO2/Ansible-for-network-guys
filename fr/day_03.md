...
La plupart des modules effectue les actions sur le serveur distant. Nous avons vu le module *raw* qui se contente de lancer la commande donnée en paramètre (ici *show clock*), ce qui est intuitif. En revanche, le module copy (qui copie des fichiers) ou le module template (qui sera vu en dern
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0NTgzNzkzNywxOTYwMTQ0NDEwXX0=
-->