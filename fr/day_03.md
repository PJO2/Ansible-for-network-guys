...
La clef, c'est le paramètre --connection (ou -c) qui spécifie la portée du module. Par défaut, connection est positionné à ssh, mais nous pouvons aussi préciser local, pour que l'action soit faite localement par la station Ansible. Nous pouvons fin
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDQxNTYyMjQsLTIwNDYzNjUzODgsMT
k2MDE0NDQxMF19
-->