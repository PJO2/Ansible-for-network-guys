...
Le module va chercher le fichier params.csv sur le host distant. Alors, nous savons bien que le fichier n'est pas sur le host distant
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MDc3MTIzMSwxMDM5OTc2MDUxLDY4Mz
