...
Et c'est exactement ça : pour nous faciliter la vie, Ansible récolte implicitement des informations sur les hosts, comme le type d'Unix installé, le type de processeur, ansi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxNzE3MTg1OCwxNDc2ODA4MTU3LDEyMD
